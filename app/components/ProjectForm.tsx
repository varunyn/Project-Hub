...
export default function ProjectForm({ project, onSubmit, onCancel }: ProjectFormProps) {
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-[oklch(88%_0.03_255)] bg-[oklch(99%_0.006_245)] p-4 shadow-[0_1px_2px_oklch(25%_0.04_260_/_0.08)] ring-1 ring-[oklch(96%_0.025_255)]">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <h2 className="mt-1 text-xl font-semibold tracking-tight text-[oklch(24%_0.08_265)]">
            {project ? "Quest setup" : "Add quest"}
          </h2>
        </div>
        <p className="max-w-sm text-sm text-[oklch(39%_0.06_260)]">
        ...
        <section className="space-y-3 border-t border-[oklch(89%_0.035_255)] pt-4">
          ...
          <div className="flex flex-wrap items-start gap-2">
            {formData.techStack?.map((tech, index) => (
              <div
                key={tech}
                className="inline-flex items-center gap-1 rounded-md bg-[oklch(96%_0.02_250)] px-3 py-1 text-sm font-medium text-[oklch(34%_0.07_260)] ring-1 ring-[oklch(88%_0.035_255)]"
              >
                <span>{tech}</span>
                <button
                  type="button"
