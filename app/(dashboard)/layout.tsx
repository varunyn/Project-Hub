    ...
    <div className="flex h-screen min-h-screen overflow-hidden bg-slate-50">
      ...
      >
        <div className="relative flex flex-col h-full max-h-full">
          <Sidebar projects={loading ? [] : projects} sidebarId={sidebarId} />
        </div>
      </div>
      ...
      <main className="relative flex min-h-0 min-h-screen min-w-0 flex-1 flex-col overflow-hidden border-l border-slate-200/80 bg-white shadow-[inset_2px_0_4px_0_rgba(15,23,42,0.04)]">
        <div className="dashboard-main-content flex-1 min-h-0 overflow-auto transition-[margin] duration-300">
          <button
            type="button"
            className="fixed left-4 top-4 z-[30] inline-flex min-h-11 min-w-11 items-center justify-center rounded-lg border border-slate-200/80 bg-white p-2 text-slate-600 shadow-sm ring-1 ring-slate-900/5 transition-colors hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-slate-400/50 focus:ring-offset-2"
